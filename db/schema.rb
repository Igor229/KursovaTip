...
ActiveRecord::Schema.define(version: 2018_11_26_171217) do

  create_table "owns", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
