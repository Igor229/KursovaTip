...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { adress: @zone.adress, description: @zone.description, name: @zone.name } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { adress: @zone.adress, description: @zone.description, name: @zone.name } }
